...
/**
 * Created by jiangyu on 2016-07-01 10:25.
 */
public abstract class NumberText {
  ...
  /**
   * Exports a {@code NumberText} implementation instance, based on a natural language argument. {@see Lang}
   *
  ...
  /**
   * Transfers an integer number into a String, specifically in which language depends on the implementation. <p> e.g.
   * in EnglishWithDash, <p> 100 -> one hundred <br /> -976083854 -> minus nine hundred and seventy-six million and
   * eighty-three thousand eight hundred and fifty-four
   *
  ...
  /**
   * Transfers an integer number into a String of its ordinal representation, specifically in which language depends on
   * the implementation. <p> e.g. in EnglishWithDash, <p> 100 -> one hundredth <br /> 8331125 -> eight million three
   * hundred and thirty-one thousand one hundred and twenty-fifth
   *
   * @param number the integer number to be transfered
   * @return the result String
   */
  ...
  /**
   * <p> Transfers an integer number into a String of its ordinal representation, specifically in which language depends
   * on the implementation. </p> <p> <p> e.g. in EnglishWithDash, <br /><br /> 100 -> one hundredth <br /> 8331125 ->
   * eight million three hundred and thirty-one thousand one hundred and twenty-fifth </p>
   *
   * @param number the integer number to be transfered
   * @return the result String
   */
  ...
  /**
   * This enumeration type is typically named under a natural language name, and is to mark a specific implementation
   * name; it is used as an argument to call the factory method {@link NumberText#getInstance(Lang)}.
   */
  public static enum Lang {

    English(NumberTextEnglishCleanSpaceOnly.INSTANCE), EnglishWithDash(NumberTextEnglish.INSTANCE), ChineseSimplified(
        NumberTextChinese.SIMPLIFIED), ChineseTraditional(NumberTextChinese.TRADITIONAL),;
  ...
  private static class NumberTextEnglish extends NumberText {
    ...
    static enum Connect {
      ...
      Minus("minus"), Hundred("hundred"), And("and"), AfterMinus(" "), AfterNumber(" "), AfterPower(" "), AfterHundred(
          " "), AfterAnd(" "), AfterTen("-"),;
    ...
    static enum Digit {
      ...
      Zero("zero", "zeroth", "ten", ""), One("one", "first", "eleven", "ten"), Two("two", "second", "twelve",
          "twenty"), Three("three", "third", "thirteen", "thirty"), Four("four", "fourth", "fourteen", "fourty"), Five(
          "five", "fifth", "fifteen", "fifty"), Six("six", "sixth", "sixteen", "sixty"), Seven("seven", "seventh",
          "seventeen", "seventy"), Eight("eight", "eighth", "eighteen", "eighty"), Nine("nine", "nineth", "nineteen",
          "ninety"),;
  ...
  private static class NumberTextChinese extends NumberText {
    ...
    static enum Digit {
      ...
      Yi("一", "壹"), Er("二", "贰"), San("三", "叁"), Si("四", "肆"), Wu("五", "伍"), Liu("六", "陆"), Qi("七", "柒"), Ba("八",
          "捌"), Jiu("九", "玖"),;
