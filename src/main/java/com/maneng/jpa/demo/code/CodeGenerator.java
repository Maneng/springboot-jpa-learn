...
import static com.maneng.jpa.demo.code.ProjectConstant.*;
...
public class CodeGenerator {
    ...
    private static void genAssembler(String tableName, String modelName) {
        try {
            ...
            cfg.getTemplate("assembler.ftl").process(data,
                    new FileWriter(file));
            System.out.println(modelNameUpperCamel + "Assembler.java 生成成功");
        } catch (Exception e) {
            throw new RuntimeException("生成assembler失败", e);
        }
    }

    private static void genManager(String tableName, String modelName) {
        try {
            freemarker.template.Configuration cfg = getConfiguration();
            ...
            cfg.getTemplate("manager.ftl").process(data,
                    new FileWriter(file));
            System.out.println(modelNameUpperCamel + "Manager.java 生成manager成功");
        } catch (Exception e) {
            throw new RuntimeException("生成manager失败", e);
        }
    }

    private static void genQueryDto(String tableName, String modelName) {
        try {
            freemarker.template.Configuration cfg = getConfiguration();
    ...
    public static void genDto(String tableName, String modelName) {
        try {
            ...
            cfg.getTemplate("dto.ftl").process(data,
                    new FileWriter(file));
